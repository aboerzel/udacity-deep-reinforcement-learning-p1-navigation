...
class DuelingQNetwork(nn.Module):
    ...
    def __init__(self, state_size, action_size, seed, hidden_advantage=[64, 64], hidden_state_value=[64, 64]):
        ...
        ======
            ...
            hidden_advantage (list): List containing the hidden layer sizes of the advantage network
            hidden_state_value (list): List containing the hidden layer sizes of the value network
        """
